# CLAUDE.md — GymApp (raíz del proyecto)

Este archivo es el punto de entrada para cualquier agente de Claude (Claude Code, Cowork) que trabaje en este repo. Para el índice completo de documentación, ver siempre primero:
