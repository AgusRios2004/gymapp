...
import { useMonthlyTypes } from '../hooks/usePayments';
...
export default function MonthlyTypesPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (editingPlan) {
      updatePlan(editingPlan.id, data, handleCloseModal);
    } else {
      createPlan(data, handleCloseModal);
    }
  };
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-6 flex gap-3">
             ...
             <Button type="submit" className="flex-1" isLoading={isCreatingPlan || isUpdatingPlan}>
