...
import { useProducts } from '../hooks/usePayments';
                ...
                {isLoadingProducts ? (
                  ...
                  <tr key={p.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-right flex justify-end gap-2">
                       ...
                       <button onClick={() => { if(confirm("¿Seguro de borrar?")) deleteProduct(p.id) }} className="p-2 text-gray-400 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all">
                          <Trash2 size={18} />
                       </button>
                    </td>
                  </tr>
                ...
                <div className="space-y-4">
                   ...
                   <div className="pt-6 space-y-4">
                      ...
                      <Button 
                        ...
                        disabled={!selectedClient || cart.length === 0 || isCreatingSale}
      ...
      >
        <form onSubmit={handleSaveProduct} className="space-y-4">
           ...
           <div className="pt-6 flex gap-3">
              ...
              <Button type="submit" className="flex-1" isLoading={isCreatingProduct || isUpdatingProduct}>Guardar Producto</Button>
           </div>
        </form>
      </Modal>
    </div>
