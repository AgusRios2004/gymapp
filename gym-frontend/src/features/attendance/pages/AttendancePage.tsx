...
export default function AttendancePage() {
  ...
  const {
    ...
    todayAssistance,
    isLoadingAssistance: loadingAssistance,
    registerAssistance: registerAssistanceHook,
    isRegisteringAssistance: isRegistering
  } = useAttendance();
                    ...
                    filteredClients.length > 0 ? (
                        filteredClients.map((c: Client) => {
                            ...
                            return (
                                <button
                                    key={c.id}
                                    disabled={checked || isRegistering}
