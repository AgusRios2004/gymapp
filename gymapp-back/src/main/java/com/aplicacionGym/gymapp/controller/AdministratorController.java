...
public class AdministratorController {
    ...
    @GetMapping
    public ResponseEntity<WebApiResponse> getAllAdministrator(){
    ...
    @GetMapping("/{id}")
    public ResponseEntity<WebApiResponse> getAdministratorById(@PathVariable Long id){
    ...
    @PostMapping
    public ResponseEntity<WebApiResponse> createAdministrator(@RequestBody AdministratorRequestDTO administratorRequestDTO){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<WebApiResponse> updateAdministrator(@PathVariable Long id, @RequestBody AdministratorRequestDTO administratorRequestDTO){
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<WebApiResponse> deleteAdministrator(@PathVariable Long id){
