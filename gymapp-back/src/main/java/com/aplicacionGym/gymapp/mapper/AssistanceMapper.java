...
public class AssistanceMapper {
    ...
    public static AssistanceResponseDTO toDTO(Assistance assistance) {
        ...
        dto.setIdProfessor(assistance.getStaff().getId());
        dto.setProfessorName(assistance.getStaff().getName());
        dto.setDate(assistance.getDate());
        dto.setInputHour(assistance.getInputHour());
        return dto;
    }

    public static Assistance toEntity(Client client, Person staff, AssistanceRequestDTO dto) {
        return new Assistance(client, staff, dto.getDate(), dto.getInputHour());
    }
